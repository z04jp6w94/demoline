...
//取得畫面內容
$sql = " SELECT lpv_id, lpv_name, case lpv_send_status when '1' then '即時' when '2' then '預約' end as 'status', lpv_send_date ";
$sql .= $sqlFrom;
$sql .= $sqlWhere;
$sql .= " ORDER BY lpv_id DESC ";
