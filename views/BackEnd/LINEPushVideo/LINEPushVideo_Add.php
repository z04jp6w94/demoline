...
<html lang="zh-Hant-TW">
    ...
    <body>
        <div class="animsition">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-sm-6 col-xs-12">
                            <form name="createForm" id="createForm" class="push_1" method="post" action="<?php echo $fileName; ?>_Create.php" autocomplete="off" enctype="multipart/form-data">
                                <input type="hidden" id="ischange_lpv_img" name="ischange_lpv_img" value="N" />
                                <input type="hidden" id="ischange_lpv_video" name="ischange_lpv_video" value="N" />
                                <div class="panel panel-white">
                                    ...
                                    <div class="panel-body">
                                        <div>
                                            ...
                                            <label class="btn btn-danger btn-xs" id="uploadFileChooseButton"><input type="file" name="lpv_img" id="lpv_img" style="display:none;"></input>選擇檔案</label>
                                            ...
                                            <label class="btn btn-danger btn-xs" id="uploadVideoChooseButton"><input type="file" name="lpv_video" id="lpv_video" style="display:none;"></input>選擇檔案</label>
                                            <div id="uploadVideoPreviewBlock">
                                                <label id="uploadVideoDelete" for="definput"></label>
                                                <label id="uploadVideoPreview" for="definput"></label>
                                            ...
                                            <div class="form-group">
                                                <label>
                                                    <input id ="lpv_send_status" name="lpv_send_status" value="1" type="radio" checked="checked">
                                                    <span class="text">立刻發送 </span>
                                                </label>
                                                <label>
                                                    <input id ="lpv_send_status" name="lpv_send_status" value="2" type="radio">
                                            ...
                                            <div id="send_date">
                                                ...
                                                <div class="input-group">
                                                    <input class="form-control date-picker tooltip-warning" data-toggle="tooltip" data-placement="top" data-original-title="" id="lpv_send_date" name="lpv_send_date" type="text" data-date-format="yyyy-mm-dd" readonly>
                                                ...
                                                <h5>發送時間</h5>
                                                <div class="input-group">
                                                    <input class="form-control" id="timepicker" name="lpv_send_time" type="text" readonly>
                                                    <span class="input-group-addon">
            ...
            <script src="/assets_front/javascripts/LINEPushVideo/LINEPushVideo_Add.js"></script>
