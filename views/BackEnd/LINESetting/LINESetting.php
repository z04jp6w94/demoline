...
/*  */
$sqlFrom = " FROM line_setting ";
$sqlWhere = " WHERE 1 = 1";
$sqlWhere .= " and c_id = '" . $c_id . "' ";
//取得畫面內容
$sql = " SELECT c_id, ls_follow_content, ls_customer_richmenu_img  ";
$sql .= $sqlFrom;
$sql .= $sqlWhere;
$sql .= " LIMIT 1 ";
$initAry = $mysqli->readArraySTMT($sql, 3);
$ls_follow_content = $initAry[0][1];
$ls_customer_richmenu_img = $initAry[0][2];
?>
<!DOCTYPE html>
<html lang="zh-Hant-TW">
    ...
    <body>
        <div class="animsition">
                ...
                <div class="content-body">
                    <div class="row">
                        <div class="col-lg-12 col-sm-6 col-xs-12">
                            <form name="createForm" id="createForm" method="post" action="<?php echo $fileName; ?>_Update.php" autocomplete="off" enctype="multipart/form-data">
                                <input type="hidden" id="fileName" name="fileName" value="<?php echo $fileName; ?>" />
                                <input type="hidden" id="ischange_ls_customer_richmenu_img" name="ischange_ls_customer_richmenu_img" value="N" />
                                <input type="hidden" id="richmenu_img_status" name="richmenu_img_status" value="Y" />
                                <div class="panel panel-white">
                                    ...
                                    <div class="panel-body">
                                        <div>
                                            <h5><b>加入歡迎詞</b></h5>
                                            <textarea class="form-control" name="ls_follow_content" id="ls_follow_content" cols="60" rows="5" required ><?php echo $ls_follow_content; ?></textarea>                                            
                                        </div>
                                        <hr class="full-width" />
                                        <div id="tip_ls_customer_richmenu_img" class="tooltip-warning" data-toggle="tooltip" data-placement="top" data-original-title=""><label for="definput">Menu圖片</label></div>
                                        <label class="btn btn-danger btn-xs" id="uploadFileChooseButton"><input type="file" name="ls_customer_richmenu_img" id="ls_customer_richmenu_img" style="display:none;" required ></input>選擇檔案</label>
                                        <div id="uploadFilePreviewBlock">
                                            <label id="uploadFileDelete" for="definput"></label>
                                            <label id="uploadFilePreview" for="definput"><?php if ($initAry[0][2] != "") echo "<img src='" . $ls_customer_richmenu_img . "' style='width:300px;border:1px black solid;'><img>"; ?></label>
            ...
            <script src="/assets_front/javascripts/LineSetting/LineSetting.js"></script>
