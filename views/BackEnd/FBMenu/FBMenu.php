...
//取得畫面內容
$sql = " SELECT fmsm_title, fmsm_type, app_id, fmsm_text, fmsm_img, ";
$sql .= " fmsm_cdn_root, fmsm_url ";
$sql .= $sqlFrom;
$sql .= $sqlWhere;
$sql .= " ORDER BY fmsm_id ";
$initAry = $mysqli->readArraySTMT($sql, 7);
//
$sql = " SELECT  ";
$sql .= "  ";
$sql .= "  ";
                                        ...
                                        <div>
                                            ...
                                            <div>
                                                <div class="col-sm-2">
                                                    <ul class="li1_1">
                                                        <li class="col-xs-8">
                                                            <a href="#" id="" class="btn-input" value="1" style="font-weight: normal;line-height: 65px; left:30px;">輸入1</a>
                                                        </li>
                                                    </ul>
                                                    <ul class="li1_2">
                                                        <li class="col-xs-8">
                                                            <a href="#" id="" class="btn-input" value="2" style="font-weight: normal;line-height: 65px; left:30px;">輸入2</a>                                                            
                                                        </li>
                                                    </ul>
                                                    <ul class="li1_3">
                                                        <li class="col-xs-8">
                                                            <a href="#" id="" class="btn-input" value="3" style="font-weight: normal;line-height: 65px; left:100px;">輸入3</a>
                                                        </li>                                                        
                                                    </ul>
                                                </div>
                                            </div>
                                            <div>                                                
                                                <div id="radio_choose_1" style="display:inline;" class="col-sm-4">
                                                    <!--第一層 第一按鈕-->
                                                    ...
                                                    <div id="input_1_1" class="input_1" style="display:inline;">
                                                        <select id="lrcm_keyword" name="lrcm_keyword[]" class="e1" style="width: 100%;">
                                                            ...
                                                            <?php foreach ($lrcm_Ary as $rsAry) { ?>
                                                                <option value="<?php echo $rsAry[1] ?>"><?php echo $rsAry[1] ?></option>
                                                            <?php } ?>
                                                        </select>
                                                    </div>
                                            ...
                                            <div>
                                                <div class="col-sm-2">
                                                    <!--1-->    
                                                    <ul class="col-xs-12">
                                                        <a href="#" id="" class="btn-input" value="4" style="font-weight: normal;line-height: 65px; left:30px;">輸入1-1</a>
                                                    </ul>
                                                    <ul class="col-xs-12">
                                                        <a href="#" id="" class="btn-input" value="4" style="font-weight: normal;line-height: 65px; left:30px;">輸入1-2</a>
                                                    </ul>
                                                    <ul class="col-xs-12">
                                                        <a href="#" id="" class="btn-input" value="4" style="font-weight: normal;line-height: 65px; left:30px;">輸入1-3</a>
                                                    </ul>
                                                    <ul class="col-xs-12">
                                                        <a href="#" id="" class="btn-input" value="4" style="font-weight: normal;line-height: 65px; left:30px;">輸入1-4</a>
                                                    </ul>
                                                    <ul class="col-xs-12">
                                                        <a href="#" id="" class="btn-input" value="4" style="font-weight: normal;line-height: 65px; left:30px;">輸入1-5</a>
                                                    </ul>
                                                    <!--2-->
                                                    <ul class="col-xs-12">
                                                        <a href="#" id="" class="btn-input" value="4" style="font-weight: normal;line-height: 65px; left:30px;">輸入2-1</a>
                                                    </ul>
                                                    <ul class="col-xs-12">
                                                        <a href="#" id="" class="btn-input" value="4" style="font-weight: normal;line-height: 65px; left:30px;">輸入2-2</a>
                                                    </ul>
                                                    <ul class="col-xs-12">
                                                        <a href="#" id="" class="btn-input" value="4" style="font-weight: normal;line-height: 65px; left:30px;">輸入2-3</a>
                                                    </ul>
                                                    <ul class="col-xs-12">
                                                        <a href="#" id="" class="btn-input" value="4" style="font-weight: normal;line-height: 65px; left:30px;">輸入2-4</a>
                                                    </ul>
                                                    <ul class="col-xs-12">
                                                        <a href="#" id="" class="btn-input" value="4" style="font-weight: normal;line-height: 65px; left:30px;">輸入2-5</a>
                                                    </ul>
                                                    <!--3-->
                                                    <ul class="col-xs-12">
                                                        <a href="#" id="" class="btn-input" value="4" style="font-weight: normal;line-height: 65px; left:30px;">輸入3-1</a>
                                                    </ul>
                                                    <ul class="col-xs-12">
                                                        <a href="#" id="" class="btn-input" value="4" style="font-weight: normal;line-height: 65px; left:30px;">輸入3-2</a>
                                                    </ul>
                                                    <ul class="col-xs-12">
                                                        <a href="#" id="" class="btn-input" value="4" style="font-weight: normal;line-height: 65px; left:30px;">輸入3-3</a>
                                                    </ul>
                                                    <ul class="col-xs-12">
                                                        <a href="#" id="" class="btn-input" value="4" style="font-weight: normal;line-height: 65px; left:30px;">輸入3-4</a>
                                                    </ul>
                                                    <ul class="col-xs-12">
                                                        <a href="#" id="" class="btn-input" value="4" style="font-weight: normal;line-height: 65px; left:30px;">輸入3-5</a>
                                                    </ul>
                                                </div>
                                            </div>
                                            <div>
