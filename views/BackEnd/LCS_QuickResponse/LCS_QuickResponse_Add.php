...
<html lang="zh-Hant-TW">
    ...
    <body>
        <div class="animsition">
                                ...
                                <div class="panel panel-white">
                                    ...
                                    <div class="panel-body">
                                        <div>
                                            ...
                                            <hr class="full-width" />
                                            <label for="definput">快速回應文字</label>
                                            <input type="text" id="lcsmc_content" name="lcsmc_content" onchange="ChangeValue(this);" class="form-control tooltip-warning" data-toggle="tooltip" data-placement="top" data-original-title="" placeholder="請輸入快速回應文字" maxlength="50" >
                                            <hr class="full-width" />
                                        </div>
                                    </div>
                                </div>
            ...
            <script src="/assets_front/javascripts/LCS_QuickResponse/LCS_QuickResponse_Add.js"></script>
