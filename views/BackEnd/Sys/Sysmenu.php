                                        ...
                                        <tbody>
                                            <?php foreach ($initAry as $rsAry) { ?> 
                                                <tr>
                                                    ...
                                                    <td><a onClick="setKey('<?php echo $rsAry[0]; ?>');excute('folder');" class="btn btn-danger btn-sm"><i class="fa fa-folder-open"></i>建立</a></td>
                                                    <td><a onClick="setKey('<?php echo $rsAry[0]; ?>');excute('order');" class="btn btn-default btn-sm"><i class="fa fa-list-ol"></i>設定</a></td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
                                    </table>
