                    ...
                    <div class="row">
                        <div class="col-lg-12 col-sm-6 col-xs-12">
                            <form name="form1" id="form1" method="post" action="<?php echo $fileName; ?>_Create.php" autocomplete="off">
                                ...
                                <input type="hidden" id="dataKey" name="dataKey" value="<?php echo $group_id; ?>" />
                                ...
                                <div class="panel panel-white">
                                    ...
                                    <div class="panel-body">
                                        <div>
                                            ...
                                            <input type="text" class="form-control" id="definput" name="menu_folder" placeholder="請輸入主選單名稱" autocomplete="off" title="請輸入主選單名稱" required />
                                            <hr class="full-width" />
                                            <h5>選擇Icon圖</h5>
                                            <div class="row">
