...
$sqlWhere = " WHERE 1 = 1";
$sqlWhere .= " AND a.user_level in  ('system','client') ";
//確認使用者權限
$create = "disabled";
$read = "disabled";
$update = "disabled";
                                            ...
                                            <?php foreach ($initAry as $rsAry) { ?> 
                                                <tr>
                                                    <td>
                                                        ...
                                                        <?php if ($delete == "abled") { ?>
                                                            <?php if ($rsAry[8] != "system") { ?>
                                                                <a onClick="setKey('<?php echo $rsAry[0]; ?>');excute('delete');" class="btn btn-danger btn-sm"><i class="fa fa-trash-o"></i>刪除</a>
                                                            <?php } else { ?>    
                                                                <a class="btn btn-warning btn-sm tooltip-danger" data-toggle="tooltip" data-placement="top" data-original-title="系統使用帳號"><i class="fa fa-trash-o"></i>刪除</a>
                                                            <?php } ?>
                                                        <?php } ?>
                                                    </td>
