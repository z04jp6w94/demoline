                                ...
                                <div class="panel panel-white">
                                    ...
                                    <div class="panel-body">
                                        <div>
                                            ...
                                            <hr class="full-width" />  
                                            <h5><b>客戶</b></h5>
                                            <select class="e1" id="c_id" name="c_id" style="width: 100%;" required>
                                                <option value="">請選擇</option>
                                            ...
                                            <input type="text" class="form-control" id="definput" name="user_phone" placeholder="請輸入使用者電話" autocomplete="off" title="請輸入使用者電話" />
                                        </div>
                                    </div>
                                </div>
                            </form>
