...
//取得畫面內容
$sql = "SELECT cc_id, cc_name, cc_status ";
$sql .= $sqlFrom;
$sql .= $sqlWhere;
$sql .= " ORDER BY cc_status DESC , cc_id DESC ";
                                        ...
                                        <tbody>
                                            <?php foreach ($initAry as $rsAry) { ?> 
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php if ($rsAry[2] == "Y") { ?>
                                                            <a onClick="setKey('<?php echo $rsAry[0]; ?>', 'N');excute('change');" title="關閉" class="btn btn-success btn-sm"><i class="fa fa-check">啟用</i></a>
                                                           <?php } ?>
                                                           <?php if ($rsAry[2] == "N") { ?>
                                                            <a onClick="setKey('<?php echo $rsAry[0]; ?>', 'Y');excute('change');" title="開啟" class="btn btn-danger btn-sm"><i class="fa fa-close">關閉</i></a>
                                                           <?php } ?>
                                                    </td>
