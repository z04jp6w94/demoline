...
//資料庫
$sql = "SELECT cc_name FROM code_commodity WHERE cc_id = ? AND c_id = ? ";
                            ...
                            <form name="form1" id="form1" method="post" action="<?php echo $fileName; ?>_Update.php" autocomplete="off">
                                ...
                                <div class="panel panel-white">
                                    ...
                                    <div class="panel-body">
                                        <div>
                                            <label for="definput"><b>標籤名稱</b></label>
                                            <input type="text" class="form-control" id="cc_name" name="cc_name" value="<?php echo $rsVal; ?>" placeholder="請輸入標籤名稱" autocomplete="off" title="請輸入標籤名稱" required />
                                        </div>
                                    </div>
                                </div>
                            </form>
