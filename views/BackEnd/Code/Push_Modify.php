...
//資料庫
$sql = "SELECT cp_name FROM code_push WHERE cp_id = ? AND c_id = ? ";
$rsVal = $mysqli->readValuePreSTMT($sql, "ss", array($dataKey, $c_id));
?>
<!DOCTYPE html>
                            ...
                            <form name="form1" id="form1" method="post" action="<?php echo $fileName; ?>_Update.php" autocomplete="off">
                                ...
                                <div class="panel panel-white">
                                    ...
                                    <div class="panel-body">
                                        <div>
                                            <label for="definput"><b>推文分類名稱</b></label>
                                            <input type="text" class="form-control" id="cp_name" name="cp_name" value="<?php echo $rsVal; ?>" placeholder="請輸入推文分類名稱" autocomplete="off" title="請輸入推文分類名稱" required />
                                        </div>
                                    </div>
                                </div>
                            </form>
