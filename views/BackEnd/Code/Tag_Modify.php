...
//資料庫
$sql = "SELECT ct_name FROM code_tag WHERE ct_id = ? AND c_id = ? ";
                                ...
                                <div class="panel panel-white">
                                    ...
                                    <div class="panel-body">
                                        <div>
                                            ...
                                            <input type="text" class="form-control" id="ct_name" name="ct_name" value="<?php echo $rsVal; ?>" placeholder="請輸入標籤名稱" autocomplete="off" title="請輸入標籤名稱" required />
                                        </div>
                                    </div>
                                </div>
                            </form>
