...
//取得畫面內容
$sql = "SELECT mlm_id, mlm_dsp, mlm_name, mlm_email, mlm_phone, ";
$sql .= " case mlm_source ";
...
<html lang="zh-Hant-TW">
    <head>
        ...
        <script type="text/javascript">
            ...
            function Export() {
                var url = "<?php echo $fileName . "_Export.php?"; ?>";
                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-white">
                                <div class="panel-heading">
                                    <a id="add-row-btn" onClick="Export();" class="btn btn-default">匯出</a>
