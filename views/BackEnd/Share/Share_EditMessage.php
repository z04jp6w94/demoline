...
$sa_id = !empty($_REQUEST["sa_id"]) ? $_REQUEST["sa_id"] : "";
...
<html lang="zh-Hant-TW">
    <head>
        ...
        <script type="text/javascript">
            function excute(action) {
                switch (action) {
                    case "back":
                        updateForm.action = '<?php echo $fileName; ?>_UnStandard.php';
                        updateForm.submit();
                        break;
                }
            }
    ...
    <body>
        <div class="animsition">
                ...
                <div class="content-body">
                    <div class="row">
                        <div class="col-lg-12 col-sm-6 col-xs-12">
                            <form name="updateForm" id="updateForm" method="post" action="<?php echo $fileName; ?>_UnStandard.php" autocomplete="off" enctype="multipart/form-data">
                                ...
                                <input type="hidden" id="dataKey" name="dataKey" value="<?php echo ENCCode($sa_id); ?>" />
                                <input type="hidden" id="lineid" name="lineid" value="<?php echo ENCCode($dataKey); ?>" />
                                <div class="panel panel-white">
                                    ...
                                    <div class="panel-body">
                                        <div>
                                            ...
                                            <hr class="full-width" />
                                            <h5>發送訊息</h5>
                                            <textarea placeholder="請輸入發送訊息" onchange="ChangeValue(this);" class="form-control tooltip-warning" data-toggle="tooltip" data-placement="top" data-original-title="" id="send_message" name="send_message" placeholder="" cols="60" rows="5" maxlength="1500"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </form>
            ...
            <script src="/assets_front/javascripts/Share/Share_EditMessage.js"></script>
