...
//取得畫面內容
$sql = " SELECT sa_id, sa_title, entry_datetime, sa_status ";
$sql .= $sqlFrom;
$sql .= $sqlWhere;
            ...
            function excute(action) {
                switch (action) {
                    ...
                    case "standard":
                        ...
                        break;
                    case "substandard":
                        Form2.action = '<?php echo $fileName; ?>_UnStandard.php';
                        Form2.submit();
                        break;
                }
            }
                                    ...
                                    <table id="search-textbox-table" class="table table-celled">
                                        ...
                                        <tbody>
                                            <?php foreach ($initAry as $rsAry) { ?> 
                                                <tr>
                                                    <td>
                                                        <a onClick="setKey('<?php echo ENCCode($rsAry[0]); ?>');excute('substandard');" class="btn btn-default btn-sm"><i class="fa fa-search"></i>未達標</a>
                                                        <a onClick="setKey('<?php echo ENCCode($rsAry[0]); ?>');excute('standard');" class="btn btn-success btn-sm"><i class="fa fa-search"></i>已達標</a>
                                                    </td>
                                                    <td>
                                                        <?php if ($update == "abled") { ?><a onClick="setKey('<?php echo ENCCode($rsAry[0]); ?>');excute('update');" class="btn btn-info btn-sm"><i class="fa fa-edit"></i>編輯</a><?php } ?>
                                                        <?php if ($delete == "abled" && $rsAry[3] == "N") { ?><a onClick="setKey('<?php echo ENCCode($rsAry[0]); ?>');excute('delete');" class="btn btn-danger btn-sm"><i class="fa fa-trash-o"></i>刪除</a><?php } ?>
                                                    </td>
