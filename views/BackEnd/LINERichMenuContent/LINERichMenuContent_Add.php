...
<html lang="zh-Hant-TW">
    ...
    <body>
        <div class="animsition">
                                ...
                                <div class="panel panel-white">
                                    ...
                                    <div class="panel-body">
                                        <div>
                                            ...
                                            <hr class="full-width" />
                                            <div>
                                                <label for="lrcm_keyword">關鍵字</label>
                                                <input type="text" id="lrcm_keyword" name="lrcm_keyword" onchange="ChangeValue(this);" onkeyup="ValidateValue(this)" maxlength="20" class="form-control tooltip-warning" data-toggle="tooltip" data-placement="top" data-original-title="" placeholder="請輸入關鍵字" required >
                                                <hr class="full-width" />
                                            </div>
                                            <div>
                                                <h5>選擇類型</h5>
            ...
            <script src="/assets_front/javascripts/LineMenuContent/LineMenuContent_Add.js"></script>
