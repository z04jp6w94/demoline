...
/* Data */
$sql = "SELECT pc_id, line_push_type, ct_id, cm_id, pc_content ";
                                ...
                                <div class="panel panel-white">
                                    ...
                                    <div class="panel-body">
                                        <div>
                                            ...
                                            <textarea class="form-control tooltip-warning" data-toggle="tooltip" data-placement="top" data-original-title="" id="pc_content" name="pc_content" cols="60" rows="5" readonly maxlength="1500"><?php echo $initAry[0][4];?></textarea>
                                            <hr class="full-width" />
