...
<html lang="zh-Hant-TW">
    ...
    <body>
        <div class="animsition">
                                ...
                                <div class="panel panel-white">
                                    ...
                                    <div class="panel-body">
                                        <div>
                                            ...
                                            <hr class="full-width" />
                                            <h4>選擇類型</h4>
                                            <select id="line_push_type" name="line_push_type" class="e1 tooltip-warning" data-toggle="tooltip" data-placement="top" data-original-title="" style="width: 100%;">
                                                <option value="">請選擇</option>
                                                <option value="1">單張圖</option>
                                                <option value="2">按鈕</option>
                                                <option value="3">麻將牌</option>
                                            </select>    
                                            <hr class="full-width" />
                                            <h4><span id="ct_tips" class="checkbox tooltip-warning" data-toggle="tooltip" data-placement="top" data-original-title="">推播說明</span></h4>
                                            <textarea class="form-control tooltip-warning" data-toggle="tooltip" data-placement="top" data-original-title="" id="pc_content" name="pc_content" cols="60" rows="5" maxlength="1500"></textarea>
                                            <hr class="full-width" />
                                            <h4><span id="ct_tips" class="checkbox tooltip-warning" data-toggle="tooltip" data-placement="top" data-original-title="">發送目標</span></h4>
                                            <div class="checkbox">
                                                <label><input type="checkbox" id="OA" name="OA" class="checkbox-default" value="1">
                                                    <span class="text">全部官方帳號好友</span>
                                                </label>
                                            </div> 
                                            <div class="checkbox">
                                                <label><input type="checkbox" id="CheckAll" name="CheckAll" class="checkbox-default" onclick="checkAll2('CheckAll', 'ct_id');" value="1">
                                                    <span class="text">全部標籤</span>
                                                </label>
                                            </div>
                                            <div class="checkbox">
                                            ...
                                            <hr class="full-width" />
                                            <h4><span id="cm_tips" class="checkbox tooltip-warning" data-toggle="tooltip" data-placement="top" data-original-title="">選擇商品</span></h4>
                                            <div class="checkbox">
                                                <?php foreach ($cm_ary as $rsAry) { ?>
                                                    <label><input type="checkbox" id="cm_id" name="cm_id[]" onClick="DefaultCheck();" class="checkbox-info" value="<?php echo $rsAry[0]; ?>">
                                                        <span class="text"><?php echo $rsAry[1]; ?></span>
                                                    </label>
                                                <?php } ?> 
                                            </div>
            ...
            <script src="/assets_front/javascripts/CommodityPush/CommodityPush_Add.js"></script>
