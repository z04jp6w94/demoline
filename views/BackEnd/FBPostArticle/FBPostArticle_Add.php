...
$sql .= " FROM crm_m ";
$sql .= " WHERE c_id = ? ";
$c_fb_ary = $mysqli->readArrayPreSTMT($sql, "s", array($c_id), 5);
//分類代碼檔
...
<html lang="zh-Hant-TW">
    ...
    <body>
        <div class="animsition">
                                ...
                                <div class="panel panel-white">
                                    ...
                                    <div class="panel-body">
                                        <div>
                                            ...
                                            <div>
                                                <h5>選擇類型</h5>
                                                <select id="fpa_type" name="fpa_type" class="e1 tooltip-warning" data-toggle="tooltip" data-placement="top" data-original-title="" style="width: 100%;">
                                                    <option value="">請選擇</option>
                                                    <option value="1">文字&&內容</option>
                                                    <option value="2">文字&&單張圖</option>
                                                    <option value="3">文字&&網址</option>
                                                </select>                                            
                                                <hr class="full-width" />
                                            </div>
                                            <div id="sh_name">
                                                <label for="definput">貼文標題</label>
                                                <input type="text" id="fpa_name" name="fpa_name" onchange="ChangeValue(this);" class="form-control tooltip-warning" data-toggle="tooltip" data-placement="top" data-original-title="" placeholder="請輸入貼文標題" maxlength="35" >
                                                <hr class="full-width" />
                                            </div>
                                            <div>
                                                <h5>貼文分類</h5>
                                            ...
                                            <div id="sh_content">
                                                <h5>貼文內容</h5>
                                                <textarea class="form-control tooltip-warning" data-toggle="tooltip" data-placement="top" data-original-title="" id="fpa_content" name="fpa_content" placeholder="限制字數10000" cols="60" rows="5" maxlength="10000"></textarea>
                                                <hr class="full-width" />
                                            </div>
                                            <div id="sh_url">
                                                <label for="definput">貼文連結</label>
                                                <input type="text" id="fpa_url" name="fpa_url" onchange="ChangeValue(this);" class="form-control tooltip-warning" data-toggle="tooltip" data-placement="top" data-original-title="" placeholder="請輸入貼文連結">
                                                <hr class="full-width" />
                                            </div>
                                            <div id="sh_img" class="tooltip-warning" data-toggle="tooltip" data-placement="top" data-original-title="">
                                                ...
                                                <label class="btn btn-danger btn-xs" id="uploadFileChooseButton"><input type="file" name="fpa_img" id="fpa_img" style="display:none;"></input>選擇檔案</label>
                                            ...
                                            <div id="">
                                                ...
                                                <div class="form-group">
                                                    <label>
                                                        <input id ="fpa_private_replies_type" name="fpa_private_replies_type" value="1" type="radio" checked="checked">
                                                        <span class="text">留言不啟用私下回覆 </span>
                                                    </label>
                                                    <label>
                                                        <input id ="fpa_private_replies_type" name="fpa_private_replies_type" value="2" type="radio">
                                                        <span class="text">留言皆啟用私下回覆 </span>
                                                    </label>
                                                    <label>
                                                        <input id ="fpa_private_replies_type" name="fpa_private_replies_type" value="3" type="radio">
                                                        <span class="text">留言搭配關鍵字啟用私下回覆 </span>
                                                    </label>
                                                </div>
                                                <hr class="full-width" />
                                            </div>
                                            <div id="sh_keyword">
                                                ...
                                                <input type="text" id="fpa_private_replies_keyword" name="fpa_private_replies_keyword" onchange="ChangeValue(this);" class="form-control tooltip-warning" data-toggle="tooltip" data-placement="top" data-original-title="" placeholder="請輸入關鍵字" maxlength="10" >
                                                <hr class="full-width" />
                                            </div> 
                                            <div id="sh_replies">
                                                <h5>私下回覆內容</h5>
                                                <textarea class="form-control tooltip-warning" data-toggle="tooltip" data-placement="top" data-original-title="" id="fpa_private_replies" name="fpa_private_replies" placeholder="限制字數500" cols="60" rows="5" maxlength="500"></textarea>
                                                <hr class="full-width" />
                                            </div>
                                            <div id="">
                                                <h5>發送狀態</h5>
                                                ...
                                                <div class="form-group">
                                                    <label>
                                                        <input id ="fpa_push_type" name="fpa_push_type" value="1" type="radio" checked="checked">
                                                        <span class="text">立刻發送 </span>
                                                    </label>
                                                    <label>
                                                        <input id ="fpa_push_type" name="fpa_push_type" value="2" type="radio">
                                            ...
                                            <div id="send_date">
                                                ...
                                                <div class="input-group">
                                                    <input class="form-control date-picker tooltip-warning" data-toggle="tooltip" data-placement="top" data-original-title="" id="scheduled_date" name="scheduled_date" type="text" data-date-format="yyyy-mm-dd" readonly>
                                                ...
                                                <h5>發送時間</h5>
                                                <div class="input-group">
                                                    <input class="form-control tooltip-warning" id="timepicker" name="scheduled_time" type="text" data-original-title="" readonly>
                                                    <span class="input-group-addon">
            ...
            <script src="/assets_front/javascripts/FBPostArticle/FBPostArticle_Add.js"></script>
