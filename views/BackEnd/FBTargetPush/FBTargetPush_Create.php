...
//取得新增參數
        ...
        switch ($fpm_push_type) {
            ...
            case '2'://圖像     
                ...
                $serverFilePath = "assets_rear/images/fb_target_push/" . $c_id . "/" . $_RandRoot;
                $ThumbnailSize = 250;
                $pictureFile = new BackEndPictureFileForWork($oldfileName, $newfileName, $tempFilePath, $serverFilePath, $ThumbnailSize);
                $pictureFile->createFolder("assets_rear/images/fb_target_push");
                $pictureFile->createFolder("assets_rear/images/fb_target_push/" . $c_id);
