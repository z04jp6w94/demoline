...
/* Data */
$sql = "SELECT fpm_id, fpm_push_type, fpm_send_status, fpm_send_date";
$sql .= " FROM fb_push_messenger ";
$sql .= " WHERE fpm_id = ?";
$sql .= " AND c_id = ? ";
$FBPMAry = $mysqli->readArrayPreSTMT($sql, "ss", array($dataKey, $c_id), 4);
$datetime = $FBPMAry[0][3];
$sendDate = date('Y-m-d', strtotime($datetime));
$sendTime = date('h:i A', strtotime($datetime));
/* Carousel */
$sql = " SELECT COUNT(fpmd_id) FROM fb_push_messenger_d ";
$sql .= " WHERE fpm_id = ? ";
$sql .= " AND deletestatus = 'N' ";
$FBPM_COUNT = $mysqli->readValuePreSTMT($sql, "s", array($dataKey));
?>
<!DOCTYPE html>
<html lang="zh-Hant-TW">
    ...
    <body>
        <div class="animsition">
                ...
                <div class="content-body">
                    <div class="row">
                        <div class="col-lg-12 col-sm-6 col-xs-12">
                            <form name="updateForm" id="updateForm" class="push_1" method="post" action="<?php echo $fileName; ?>_Update.php" autocomplete="off" enctype="multipart/form-data">
                                <input type="hidden" id="fileName" name="fileName" value="<?php echo $fileName; ?>" />
                                <input type="hidden" id="dataKey" name="dataKey" value="<?php echo $FBPMAry[0][0]; ?>" />
                                <input type="hidden" id="temp_fpm_push_type" name="temp_fpm_push_type" value="<?php echo $FBPMAry[0][1]; ?>" />
                                <input type="hidden" id="count_lrcm_img" name="count_lrcm_img" value="<?php echo $FBPM_COUNT; ?>" />
                                <input type="hidden" id="count_carousel" name="count_carousel" value="<?php echo $FBPM_COUNT; ?>" />
                                        ...
                                        <div>
                                            ...
                                            <div>
                                                ...
                                                <div class="form-group">
                                                    <label>
                                                        <input id ="fpm_send_status" name="fpm_send_status" value="1" type="radio" <?php
                                                    if ($FBPMAry[0][2] == "1") {
                                                    ...
                                                    <label>
                                                        <input id ="fpm_send_status" name="fpm_send_status" value="2" type="radio"<?php
                                                    if ($FBPMAry[0][2] == "2") {
                                                        echo 'checked="checked"';
                                                    }
                                                    ?> disabled>
                                            ...
                                            <div id="send_date">
                                                ...
                                                <div class="input-group">
                                                    <input class="form-control date-picker tooltip-warning" data-toggle="tooltip" data-placement="top" data-original-title="" id="fpm_send_date" name="fpm_send_date" type="text" data-date-format="yyyy-mm-dd" value="<?php echo $sendDate?>" readonly>
                                                ...
                                                <h5>發送時間</h5>
                                                <div class="input-group">
                                                    <input class="form-control" id="timepicker" name="fpm_send_time" type="text" value="<?php echo $sendTime?>" readonly>
                                                    <span class="input-group-addon">
                                            ...
                                            <div>
                                                <h5>選擇類型</h5>
                                                <select id="fpm_push_type" name="fpm_push_type" class="e1 tooltip-warning" data-toggle="tooltip" data-placement="top" data-original-title="" style="width: 100%;" disabled>
            ...
            <script src="/assets_front/javascripts/FBTargetPush/FBTargetPush_Modify.js"></script>
