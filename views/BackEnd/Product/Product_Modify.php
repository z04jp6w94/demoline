...
$sql = "SELECT p_id, p_number, p_name, p_price, p_remark ";
$sql .= " FROM product_m ";
$sql .= " WHERE p_id = ?";
$initAry = $mysqli->readArrayPreSTMT($sql, "s", array($dataKey), 5);
?>
<!DOCTYPE html>
                                ...
                                <div class="panel panel-white">
                                    ...
                                    <div class="panel-body">
                                        <div>
                                            ...
                                            <input type="text" class="form-control" id="p_number" name="p_number" value="<?php echo $initAry[0][1];?>" autocomplete="off" readonly />                                       
                                            <hr class="full-width" /> 
                                            <label for="definput"><b>產品名稱</b></label>
                                            <input type="text" class="form-control" id="p_name" name="p_name" value="<?php echo $initAry[0][2];?>" placeholder="請輸入產品名稱" autocomplete="off" title="請輸入產品名稱" required />
                                            <hr class="full-width" />                                                                                
                                            <label for="definput"><b>產品價格</b></label>
                                            <input type="text" class="form-control" id="p_price" name="p_price" value="<?php echo $initAry[0][3];?>" onKeyUp="return this.value = this.value.replace(/\D/g, '')" placeholder="請輸入產品價格" autocomplete="off" title="請輸入產品價格" required />
                                            <hr class="full-width" />
                                            <h5><b>產品備註</b></h5>
                                            <textarea class="form-control" id="p_remark" name="p_remark" placeholder=""><?php echo $initAry[0][4];?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </form>
