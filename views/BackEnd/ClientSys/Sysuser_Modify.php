                                ...
                                <div class="panel panel-white">
                                    ...
                                    <div class="panel-body">
                                        <div>
                                            ...
                                            <div class="radio">
                                                <label>
                                                    <input name="user_status" type="radio" value="Y" <?php
                                                    if ($initAry[0][1] == 'Y') {
                                                        echo 'checked';
                                                    }
                                                    ?>>
                                            ...
                                            <div class="radio">
                                                <label>
                                                    <input name="user_status" type="radio" value="N" <?php
                                                    if ($initAry[0][1] == 'N') {
                                                        echo 'checked';
                                                    }
                                                    ?>>
                                            ...
                                            <input type="text" class="form-control" id="url" name="user_password" value="<?php echo DECCode($initAry[0][3]); ?>" placeholder="請輸入使用者密碼" autocomplete="off" title="請輸入使用者密碼" required />
                                            <hr class="full-width" />
                                            <label for="definput"><b>系統使用者姓名</b></label>
                                            <input type="text" class="form-control" id="url" name="user_name" value="<?php echo $initAry[0][4]; ?>" placeholder="請輸入使用者姓名" autocomplete="off" title="請輸入使用者姓名" required />
                                            <hr class="full-width" />
                                            <label for="definput"><b>系統使用者地址</b></label>
                                            <input type="text" class="form-control" id="url" name="user_address" value="<?php echo $initAry[0][5]; ?>" placeholder="請輸入使用者地址" autocomplete="off" title="請輸入使用者地址" />
                                            <hr class="full-width" />
                                            <label for="definput"><b>系統使用者信箱</b></label>
                                            <input type="email" class="form-control" id="url" name="user_email" value="<?php echo $initAry[0][6]; ?>" placeholder="請輸入使用者信箱" autocomplete="off" title="請輸入使用者信箱" required />
                                            <hr class="full-width" />
                                            <label for="definput"><b>系統使用者電話</b></label>
                                            <input type="text" class="form-control" id="url" name="user_phone" value="<?php echo $initAry[0][7]; ?>" placeholder="請輸入使用者電話" autocomplete="off" title="請輸入使用者電話" onKeyUp="return this.value = this.value.replace(/\D/g, '')" />
                                        </div>
                                    </div>
                                </div>
                            </form>
