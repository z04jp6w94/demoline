            ...
            function excute(action) {
                switch (action) {
                    case "update":
                        ...
                        break;
                    case "folder":
                        Form2.action = 'Sysfolder.php';
                        Form2.submit();
                        break;
                    case "order":
                        Form2.action = 'Sysmenu_Order_Modify.php';
                        Form2.submit();
                        break;
                }
            }
                                        ...
                                        <tbody>
                                            <?php foreach ($initAry as $rsAry) { ?> 
                                                <tr>
                                                    ...
                                                    <td><a onClick="setKey('<?php echo ENCCode($rsAry[0]); ?>');excute('folder');" class="btn btn-danger btn-sm"><i class="fa fa-folder-open"></i>建立</a></td>
                                                    <td><a onClick="setKey('<?php echo ENCCode($rsAry[0]); ?>');excute('order');" class="btn btn-default btn-sm"><i class="fa fa-list-ol"></i>設定</a></td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
                                    </table>
