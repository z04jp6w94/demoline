...
/* 被標籤次數 */
$sql = " select ct.ct_name, (select count(*) from member_list_t mlt where mlt.mlm_lineid = ? and c_id = ? and mlt.ct_id = ct.ct_id)  ";
...
$mlt_ary = $mysqli->readArrayPreSTMT($sql, "ss", array($c_id, $mlm_lineid), 3);
?>
<!DOCTYPE html>
