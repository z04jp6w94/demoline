...
//資料庫
$sql = "SELECT fpm_id, fpm_push_type ";
                ...
                <div class="content-body">
                    <div class="row">
                        <div class="col-lg-12 col-sm-6 col-xs-12">
                            <form name="updateForm" id="updateForm" class="push_1" method="post" action="<?php echo $fileName; ?>_TargetPush.php" autocomplete="off">
                                <input type="hidden" id="dataKey" name="dataKey" value="<?php echo $dataKey; ?>" />
                                <input type="hidden" id="fpm_push_type" name="fpm_push_type" value="<?php echo $initAry[0][1]; ?>" />
