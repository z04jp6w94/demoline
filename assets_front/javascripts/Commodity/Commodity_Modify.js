...
jQuery(document).ready(function () {
    var temp_cm_type = $('#cm_type_value').val();
    if (temp_cm_type == '1') {
        $('#type1').show();
        $('#type2').hide();
    } else if (temp_cm_type == '2') {
        $('#type1').hide();
        $('#type2').show();
    }
    /*radio*/
...
function chkFormField(updateForm) {
    ...
    if (FormDataEmptyTooltip(updateForm.cm_name)) {
    ...
    } else if (updateForm.ischange_cm_img.value === 'Y' && FormDataEmptyTooltip(updateForm.cm_img)) {
        ...
        if (cm_type == '1') {
            ...
            if (FormDataEmptyTooltip(updateForm.cm_url)) {
