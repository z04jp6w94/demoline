...
class VideoMessageHandler implements EventHandler {
     ...
     */
    public function __construct(VideoMessage $videoMessage, $bot, $databaseProcessor, $redis, $i18n, $channelId, $access_token, $s3) {
    ...
    public function handle() {
        ...
        $video = $this->_bot->getMessageContent($contentId)->getRawBody();
